 ...
 * Если пользователь вводит имя котика, то все котики с этим именем выводятся и в конце пишется
 * количество таких котиков. Причем регистр имени котика не важен, то есть "мурка" и "Мурка" ищет,
 * выводит и считает всех мурок и Мурок в списке
 */

public class CatCardIndex {
}
